...
parser.add_argument("-task_governor"  , type=int, default=None, help="setting of continual learning for multiple task")
...
parser.add_argument("--use_amp"      , action="store_true", help="use amp for fp16")
parser.add_argument("--debug"        , action="store_true", help="in debug mode, program will shows more information")
...
dualprompt.add_argument("-pos_e_prompt" , type=int, default = 1, nargs='+')
...
# Optimizer Parser for Each Model
...
# Scheduler Parser for Each Model
const = argparse.ArgumentParser()
const.add_argument("-lr"           , type=float, default=0.001)
const.add_argument("-step_size"    , type=int, default=1)
const.add_argument("-gamma"        , type=float, default=0.1)
const.add_argument("-last_epoch"   , type=int, default=0)
