...
el2p.add_argument("--_learnable-pos-emb",   default=True,  action= argparse.BooleanOptionalAction, help="randomize the order of prompt")
...
certl2p.add_argument("--_learnable-pos-emb",   default=True,  action= argparse.BooleanOptionalAction, help="randomize the order of prompt")
